...
/// Onglet Document : liste et gestion des documents du projet.
class ProjectDetailDocumentsTab extends StatefulWidget {
  const ProjectDetailDocumentsTab({
    super.key,
    required this.auth,
  ...
  State<ProjectDetailDocumentsTab> createState() =>
      _ProjectDetailDocumentsTabState();
}

class _ProjectDetailDocumentsTabState extends State<ProjectDetailDocumentsTab>
